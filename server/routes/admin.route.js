...
import { loginAdmin, registerAdmin, addQuestion, getAdminProfile, getDashboardStats, getAllQuestions, deleteQuestion, editQuestion, viewResultPageDetails, viewStudentAnswers, markDescriptiveAnswer } from "../controllers/admin.controller.js";
...
router.put("/mark-descriptive", verifyAdmin(["superadmin", "moderator"]), markDescriptiveAnswer);
